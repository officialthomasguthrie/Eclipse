//! `rift ai`: a question for Aura from the terminal. An answer is printed. A command Aura
...
//! Aura's state. `rift ai index` and `rift ai search` are search by meaning in home.

use std::process::ExitCode;

use librift::aura::{self, Reply, Status};
