//! Makes a small image laid out like a real one, and checks a drive eclipse-flash wrote from it. CI
...
//! `test-drive check <drive>` checks what eclipse-flash wrote from it onto a disk or into a file.
...
use libeclipse::disk::{GPT_BYTES, read_gpt};
