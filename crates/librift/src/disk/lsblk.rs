...
mod tests {
          ...
          {"name": "sdb", "path": "/dev/sdb", "type": "disk", "size": 61530439680, "rm": false, "ro": false,
           ...
           "children": [
              {"name": "sdb1", "path": "/dev/sdb1", "type": "part", "size": 61529391104, "rm": false,
               ...
               "mountpoints": ["/run/media/rift/STICK"], "fstype": "exfat", "partlabel": "Main Data Partition",
               "log-sec": 512}
           ]}
       ]
    }"#;
    ...
    fn lsblk_is_read_with_its_children() {
        ...
        assert_eq!(
            ...
            [Some("/run/media/rift/STICK".to_string())]
        );
    ...
    fn disks_a_drive_must_not_be_written_onto_are_refused() {
        ...
        refused(&stick(), "/dev/sdb1 is mounted on /run/media/rift/STICK");
        ...
        small.size = 16 * GIB;
        refused(&small, "holds 16.0 GiB, and Rift needs 21.1 GiB");
    }
