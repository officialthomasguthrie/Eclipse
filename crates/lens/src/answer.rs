//! Quasar's answer in the list under the field. Asking and reading the reply is librift's
//! `quasar` module, which the rift command shares; how the words fit the list is the panel's.
