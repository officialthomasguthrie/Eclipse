//! `eclipse doctor`: one row per check with the numbers it read, then a count. It exits with 1
...
use libeclipse::aura::{self, Status};
use libeclipse::{paths, syzygy};

use crate::text;

const USAGE: &str = "Usage: eclipse doctor";
